...
public class SearchResult implements Comparable<SearchResult> {
	...
	public static void dumpDocno( Retrieval retrieval, Collection<SearchResult> results ) throws IOException {
		for ( SearchResult result : results ) {
			result.setDocno( retrieval.getDocumentName( result.docid ) );
		}
	}
